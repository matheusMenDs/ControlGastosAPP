Projeto: APP de Controle de Gastos Mensais desenvolvido pra mim.

Descrição:

Resumo: Aplicativo desktop para controle de gastos pessoais (Gastos Mensais v6). Permite registrar, visualizar e gerenciar despesas e receitas em uma interface local baseada em Electron/HTML/CSS/JS.
Objetivo: Ajudar usuários a acompanhar gastos mensais, categorizar despesas e consultar histórico de movimentações de forma rápida e offline.
